...
Tested Boss and its minions: In the main menu, you can select “Test Boss” which brings you to an area where you can fight the bell boss, which, compared to other enemies, appears with a different sprite, size, takes no knockback, has different attacks and two phases, and has a bigger health pool
Tested Shop: Walking to the NPC brings up a prompt for the player to spend coins and buy items.  The player can not buy infinite items, coins are deducted when the player buys an item, and the player can not buy anything if they don't have enough coins.
